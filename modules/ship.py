...
def main():
    ...
    level = logic.game.get_level() # TODO(Yethiel): Remove when better loading is implemented
...
def setup():
    # Add the object reference to the game object and receive an id in return
    ...
    # prepare the ship's own entry in the global dict TODO: remove
    # logic.game.get_shipref["last_checkpoint"] = None
    ...
    logic.game.assign_ship_to_player(own["id"], own["player_id"])
